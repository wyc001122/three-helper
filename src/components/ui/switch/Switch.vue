...
<template>
  ...
  >
    <SwitchThumb
      :class="cn('pointer-events-none block h-3 w-3 rounded-full bg-background shadow-lg ring-0 transition-all [state=unchecked]:translate-x-0 data-[state=checked]:translate-x-4 duration-300')"
    >
      <slot name="thumb" />
    </SwitchThumb>
  </SwitchRoot>
